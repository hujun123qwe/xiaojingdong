				...
				<div class="l">
					<div class="pro">
							...
							<div class="shijian" id="shijian1_0">
								<i></i> <span id="ps_label_55" style="text-align: center;" over="false">预售中</span> <span id="ps_cd_55" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
			            ...
			            $(function(){
			              ...
			              $("#shijian_0").mouseleave(function(){
							...
							<div class="shijian" id="shijian1_1">
								<i></i> <span id="ps_label_62" style="text-align: center;" over="false">预售中</span> <span id="ps_cd_62" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
			            ...
			            $(function(){
			              ...
			              $("#shijian_1").mouseleave(function(){
							...
							<div class="shijian" id="shijian1_2">
								<i></i> <span id="ps_label_67" style="text-align: center;" over="false">预售中</span> <span id="ps_cd_67" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
