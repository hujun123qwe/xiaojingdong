...
<title>2015夏装韩版修身白色小西装女薄外套_连衣裙_女装馆_服装服饰_小京东商城  </title>
...
<body>
<input type="hidden" id="chat_goods_id" value="45" />
...
<table cellpadding=0 cellspacing=0 width="90%" border=0>  
    <tr> 
      ...
      <p style="font-size:15px;font-weight:bold;color:#F52648;padding-bottom:5px;">2015夏装韩版修身白色小西装女薄外套</p>
    ...
    <tr> 
      ...
      <input type="hidden" value="45" name="goods_id" id="goods_id">
  ...
  <div class="tell_me_con">
  	<table cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <td colspan="2" align="left" style="padding:15px 0 15px 0;"><div style="background:#FFFDEE ;padding:10px 10px;border:1px dotted #ff3300;height:40px;line-height:150%; font-weight:normal">
            <p style="font-size:15px;color:#F52648;padding-bottom:5px;">2015夏装韩版修身白色小西装女薄外套</p>
    ...
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      ...
      <tr>
        <td class="td_l">&nbsp;</td>
        <td align="left" class="td_r"><input type="button" value="提交" onclick="tell_me1(45)" class="tell_btn"/>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">服装服饰</a> <code>&gt;</code> <a href="category.php?id=55">女装馆</a> <code>&gt;</code> <a href="category.php?id=61">连衣裙</a> <code>&gt;</code> 2015夏装韩版修身白色小西装女薄外套</div>
</div>
<div class="blank"></div>
  <div class="w">
            ...
            <div id="name">
              ...
              <div class="mar_l">
                <p> 
                  ...
                  <span class="depreciate"><a href="javascript:showDiv(45);" style="color:#ffffff;text-decoration:none;">降价通知</a></span> </p>
              </div>
              <div class="show_price" style="z-index:101"> 
                  ...
                  <div class="hover" style="display:none;" id="vip2" onmouseover="hidevip1()" onmouseout="showvip1()"> <span class="rmbPrice">会员等级价格<i></i></span> 
                    ...
                    <span class="rmbPrice"> 普通会员：399.0</span> 
...
document.getElementById('vip2').style.display="none";
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=45#os_pinglun">1人评价</a></span></p>
                </li>
                <li>
                ...
                <div class="dd catt"> 
                  ...
                  <ul class="ys_xuan" id="xuan_15">
                    <div class="catt" id="catt_15"> 
                      ...
                      <a onclick="show_attr_status(this,45, 15);get_gallery_attr(45, 49);"  href="javascript:" name="49" id="xuan_a_49"  title="[ 0.00]">                       <div style="padding:3px 7px;">米色</div>
                                            <input style="display:none" id="spec_value_49" type="radio" name="spec_15" value="49"  />
                      </a> 
                ...
                <div class="dd catt"> 
                  ...
                  <ul class="ys_xuan" id="xuan_16">
                    <div class="catt" id="catt_16"> 
                      ...
                      <a onclick="show_attr_status(this,45, 15);"  href="javascript:" name="50" id="xuan_a_50"  title="[ 0.00]">                       <div style="padding:3px 7px;">L</div>
                                            <input style="display:none" id="spec_value_50" type="radio" name="spec_16" value="50"  />
                      </a> 
                       
                      <a onclick="show_attr_status(this,45, 15);"  href="javascript:" name="51" id="xuan_a_51"  title="[ 0.00]">                       <div style="padding:3px 7px;">XL</div>
                                            <input style="display:none" id="spec_value_51" type="radio" name="spec_16" value="51"  />
                      </a> 
...
myString[1]="|49|51|";
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> 
                                                                             （库存<font id="shows_number">298 </font>）
                                      </div>
                </div>
              </li>
                          </ul>
            <div class="buyNub-buy-wrap">
             ...
             <div id="choose-btns1" class="buyNub-buy" style="display:none"> 
                ...
                <a onclick="tell_me(45)" class="tell_me"/><i></i>到货通知</a>
                
                <a href="javascript:collect(45)" class="btn-coll ">收藏</a>   
              </div>
     
              <div id="choose-btns" class="buyNub-buy"> 
                 
                <a href="javascript:addToCart(45,0,1)" name="bi_addToCart" class="u-buy1">立即购买</a> <a href="javascript:addToCart(45)" name="bi_addToCart" class="u-buy2">加入购物车</a> 
                 
                <a href="javascript:collect(45)" class="btn-coll ">收藏</a> <a id="phone" class="btn-phone" style="position:relative;cursor:pointer">去手机购买
                <div id="phone_tan" style="display:none"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img src="erweima_png.php?id=45" width="100" height="100" /> </div>
                </div>
                </a>  
              </div>
              <script type="text/javascript">
      ...
      <div id="preview">
        <div  class="goods_img" id="li_45"> <a href="images/201507/source_img/45_P_1437516035784.jpg" class="MagicZoom" id="zoom" rel="zoom-position: right;"> 
           
          <img  src="images/201507/goods_img/45_P_1437516035119.jpg" class="goodsimg pic_img_45" id="goods_bimg" width="378" height="378" style="border:#DDDDDD 1px solid; width:378px; height:378px;" /> 
...
<div class="clearfix" class="goods_picture"> <span class="scrleft" onmouseover="moveLeft()" onmousedown="clickLeft()" onmouseup="moveLeft()" onmouseout="scrollStop()"></span>
  <div class="gallery">
    <div id="demo">
      <div id="demo1" style="float:left;">
        <ul id="goods_gallery">
                    <li>
	    <a  href="images/201507/source_img/45_P_1437516035784.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/45_P_1437516035119.jpg"   title="" >
	    <img src="images/201507/thumb_img/45_thumb_P_1437516035017.jpg" alt="2015夏装韩版修身白色小西装女薄外套" class="B_blue"  />
	    </a>
          </li>
                  </ul>
      </div>
  ...
  <script>
      ...
      function clickRight() {
        ...
        <div id="short-share">
          <div id="view-bigimg" class="fl" style="margin-right:20px;"><b></b><a href="javascript:;" onclick="window.open('gallery.php?id=45'); return false;" target="_blank">查看大图</a></div>
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="45" data-type="2" onclick="Compare.add(45,'2015夏装韩版修身白色小西装女薄外套','2', 'images/201507/thumb_img/45_thumb_G_1437516035103.jpg', '399.0 ')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
  ...
  554fcae493e564ee0dc75bdf2ebf94caads|a:3:{s:4:"name";s:3:"ads";s:2:"id";N;s:3:"num";N;}554fcae493e564ee0dc75bdf2ebf94ca 
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            <li class="boldtit_list h_list" onclick="change_widget(1, this);"><a href="/goods.php?id=45#os_canshu">规格参数</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=45#os_jieshao" >商品介绍</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=45#os_pinglun" >商品评价(1)</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=45#os_shouhou" >售后保障</a></li>
          </ul>
          <div style="width:170px;float:right; position:relative;left:0;top:0"> <a href="javascript:addToCart(45)" name="bi_addToCart"  class="right_add" >加入购物车</a>
            <div class="ce_right">
              <ul class="abs_ul">
        ...
        <div id="main_widget_1">
          <div class="mc" id="os_canshu">
            <ul class="detail-list">
              <li>商品名称：2015夏装韩版修身白色小西装女薄外套</li>
              <li>商品编号：ECS000045</li>
              <li>品牌：<a href="brand.php?id=55" >卓诗尼</a></li>
	...
	<ul class="clearfix">
    	<li class="hpd"><div>100%</div><p>好评度</p></li>
        <li class="pre">
        	<dl class="clearfix"><dt>好评<span>(100%)</span></dt><dd><div style="width:100%"></div></dd></dl>
...
<div class="my_comment_tab">
	<ul class="clearfix">
    	<li id="mct_0" onClick="ShowMyComments(45,0,1)" class="cur">全部评价<span>(1)</span></li>
    	<li id="mct_1" onClick="ShowMyComments(45,1,1)">好评<span>(1)</span></li>
    	<li id="mct_2" onClick="ShowMyComments(45,2,1)">中评<span>(0)</span></li>
    	<li id="mct_3" onClick="ShowMyComments(45,3,1)">差评<span>(0)</span></li>
    	<li id="mct_4" onClick="ShowMyComments(45,4,1)">用户晒单<span>(0)</span></li>
    </ul>
</div>
<div class="blank"></div>
