<div class="wenti">
    ...
    <div class="list">
      <div class="question clearfix">
        ...
        <strong class="common_right">预售商品下单后可以修改订单吗？</strong>
      </div>
    ...
    <div class="list">
      <div class="question clearfix">
      	<span class="icon Left"></span> 
        <strong class="common_right">预售商品什么时候可以到货？？</strong>
      </div>
      <div class="answer clearfix">
      	<span class="icon Left"></span>
        <p class="common_right">商品如果是预定的状态，需要向供货商采购，入库后才能发货，一般2-20天左右。</p>
      </div>
    </div>
    <div class="list">
      <div class="question clearfix">
